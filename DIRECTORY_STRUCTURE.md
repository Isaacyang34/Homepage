...
│   └── kavas_blower_control/      # KAVAS 鼓風機 ESP32 Wi-Fi 雲端 3通道資料記錄器專案 (KAVAS手冊.pdf, KAVAS_ESP32_DataLogger_Design.md, kavas_esp32_logger.ino, google_script.js, index.html, simulator.html)
│

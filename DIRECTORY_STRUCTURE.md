...
│   └── kavas_blower_control/      # KAVAS 鼓風機 ESP32 Wi-Fi 雲端 3通道資料記錄器專案 (KAVAS手冊.pdf, KAVAS_ESP32_DataLogger_Design.md, PROJECT_PRESENTATION_BRIEFING.md, PROJECT_BRIEFING_FOR_NOTEBOOKLM.md, BOM_List.md, presentation.html, 3d_view.html, kavas_esp32_logger.ino, google_script.js, index.html, simulator.html)
│

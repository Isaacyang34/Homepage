...
| **6** | **防水接頭** | **PG7 / PG9 電缆防水固定接頭 (Cable Gland)**<br>*(安裝於防水盒側邊出線孔，鎖緊 AC 110/220V 電源線及 RS485 訊號線)* | 4 個 | 🔗 [PG 電纜防水接頭搜尋列表](https://shop.cpu.com.tw/Search/advanced/4d4158343835/page/1/) | 約 $15 ~ $30 |
...
| **9** | **內部配線** | **2.54mm 杜邦線包 + 萬用洞洞板 (PCB) + 2P/3P 接線端子**<br>*(控制箱內部模組接線與 RS485 鎖線)* | 1 套 | 🔗 [杜邦線與週邊購買連結](https://shop.cpu.com.tw/Search/advanced/4448543232/page/1/) | 約 $100 |
| **10** | **485專用線材** | **RS485 工業級雙絞屏蔽電纜線 (24AWG 1對/2芯 雙隔離網)**<br>*(針對 3 台鼓風機跨度 8 米現場佈線，雙絞抗噪 + 屏蔽網導出變頻器干擾)* | **12 ~ 15 米** | 🔗 [RS485 雙絞屏蔽線購買連結](https://shop.cpu.com.tw/Search/advanced/525334383520e99b9be7b79a/page/1/) | 約 $15 ~ $25 /米 |
| **11** | **終端匹配** | **120 歐姆 (120Ω) 1/4W 臥式精密終端電阻**<br>*(並聯於最遠端 8 米處鼓風機驅動器 RS485 A/B 端子上，消除高頻信號波形反射)* | 2 顆 | 🔗 [120Ω 精密電阻購買連結](https://shop.cpu.com.tw/Search/advanced/313230cf89/page/1/) | 約 $2 ~ $5 /顆 |
...
### 💡 現場 8 米長距離 RS485 工業佈線注意事項：

1. **菊花鏈拓樸 (Daisy Chain) 嚴禁星狀拓樸**：
   - 3 台鼓風機的 A 線與 B 線必須採用「手拉手 (A接A、B接B)」串接方式，**切勿從控制箱分別拉 3 條獨立線（星狀拓樸）**，否則極易產生信號反射亂碼。
2. **屏蔽網單點接地 (Shield Grounding)**：
   - RS485 雙絞屏蔽線外層的金屬編織網/鋁箔，請在 ESP32 控制箱端**單點連接至大地 (GND / Earth)**，最遠端鼓風機處屏蔽網懸空，避免形成地迴路雜訊。
3. **120 歐姆終端電阻 (Terminal Resistor)**：
   - 在距離最遠（約 8 米）的 **3 號鼓風機驅動器 A/B 端子之間**，跨接一顆 120Ω 電阻，用來阻抗匹配並吸收波形反射。

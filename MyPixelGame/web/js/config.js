...
const WORLD_AREAS = [
  ...
  },
  {
    ...
    enemies: [
      { id: 3, x: 220, y: 140, hp: 120, maxHp: 120, name: '洞穴岩魔', aiType: 'golem', color: '#8e44ad', spd: .5, atk: 18, reward: { stones: 35, exp: 50 } },
      { id: 4, x: 360, y: 90, hp: 70, maxHp: 70, name: '幽影冥蝠', aiType: 'bat', color: '#3498db', spd: 1.1, atk: 12, reward: { stones: 25, exp: 40 } },
    ],
    npcs: [],
    terrain: 'cave',
  },
